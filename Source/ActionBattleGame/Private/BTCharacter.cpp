...
void ABTCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	// Nwe Enhanced Input system
	UEnhancedInputComponent* InputComp = Cast<UEnhancedInputComponent>(PlayerInputComponent);

	//General
	InputComp->BindAction(Input_Move, ETriggerEvent::Triggered, this, &ABTCharacter::Move);

}

void ABTCharacter::Move(const FInputActionInstance& Instance)
{
